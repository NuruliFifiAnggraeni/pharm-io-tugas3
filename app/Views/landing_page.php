...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
        <div class="container">
            <a class="navbar-brand fw-bold" href="#"><i class="fas fa-hand-holding-medical text-warning"></i> PHARM.IO</a>
    ...
    <!-- HEADER / HERO -->
    <header class="jumbotron jumbotron-fluid text-white" style="background-color: #1a3c34;">
        <div class="container py-4">
            <h1 class="display-4 fw-bold">Katalog Produk Otomatis</h1>
            <p class="lead"> Hidup Sehat, Terkelola Lebih Baik</p>
        </div>
    </header>
        ...
        <section class="bg-white p-4 rounded shadow-sm border mb-5">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-end">
                    ...
                    <button id="btn-checkout" class="btn btn-success btn-lg w-100 fw-bold disabled">
